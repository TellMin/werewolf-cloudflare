...
const definitions = {
  ...
  madman: {
    ...
    icon: "🤪",
    team: "werewolves",
    summary: "人狼陣営の一員として村を混乱させましょう。",
    description:
      "狂人は人狼陣営の味方ですが、人狼の正体も夜の行動も知りません。言動で村を惑わせ、人狼たちの勝利に貢献しましょう。",
    abilities: [
      {
        phase: "day",
        title: "撹乱",
        summary: "発言で村を混乱させ、人狼に疑いが向かないよう誘導しましょう。",
        targetType: "team",
      },
      {
        phase: "vote",
        title: "票操作",
        summary: "人狼陣営が有利になるよう投票先を調整してください。",
        targetType: "player",
      },
    ],
  },
